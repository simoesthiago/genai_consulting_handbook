...
- [`../01_foundations/1.2_prompt_engineering.md`](../01_foundations/1.2_prompt_engineering.md) - Prompts as product requirements (not just copywriting)
...
- [`2.6_observability_llomps.md`](./2.6_observability_llomps.md) - Monitoring in production and closing the improvement loop
...
Online monitoring should feed the eval set. Every week, sample real interactions (with redaction), label failures, and add them to the dataset. **A simple consulting cadence that works well is: Monday review failures and pick the top 1-2 failure types, mid-week implement one improvement, Thursday re-run offline evals on the same dataset, and Friday write a one-page update with decision and trade-offs. The rule is: ship one meaningful improvement at a time, and prove it improved the same cases without introducing new risk.**
...
- [`2.4_guardrails.md`](./2.4_guardrails.md) - What counts as P0, adversarial tests, and policy enforcement
- [`2.1_rag.md`](./2.1_rag.md) - Measuring retrieval vs generation and enforcing citations
- [`2.2_tool_calling.md`](./2.2_tool_calling.md) - Evaluating tool safety and end-to-end success
- [`2.6_observability_llomps.md`](./2.6_observability_llomps.md) - Production monitoring and closing the loop
