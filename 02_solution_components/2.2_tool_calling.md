...
**Prerequisites:**
- [`../01_foundations/1.1_llm_fundamentals.md`](../01_foundations/1.1_llm_fundamentals.md) - Why LLMs predict plausibility (and why confirmation must be based on tool results)
- [`../01_foundations/1.2_prompt_engineering.md`](../01_foundations/1.2_prompt_engineering.md) - Prompts as behavior contracts (tool usage rules, output formats)
- [`2.1_rag.md`](./2.1_rag.md) - When retrieval is appropriate (documents) vs when tools are needed (systems of record)

**Related:**
- [`2.4_guardrails.md`](./2.4_guardrails.md) - Enforcement patterns: allowlists, validation, redaction, policy checks
- [`2.5_evals.md`](./2.5_evals.md) - Measuring end-to-end tool success and gating releases
- [`2.7_agentic_ai.md`](./2.7_agentic_ai.md) - Tool calling inside agentic loops (budget, stopping criteria)
- [`2.3_mcp.md`](./2.3_mcp.md) - Governed integration layer for tool catalogs and access control
...
- [`2.4_guardrails.md`](./2.4_guardrails.md) - Enforcement patterns for tool safety and injection defense
- [`2.5_evals.md`](./2.5_evals.md) - Measuring tool success and gating releases
- [`2.1_rag.md`](./2.1_rag.md) - Combining document grounding with tool actions
- [`2.3_mcp.md`](./2.3_mcp.md) - Tool governance and catalog patterns for enterprise integration
