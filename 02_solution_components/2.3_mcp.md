...
**Prerequisites:**
- [`../01_foundations/1.1_llm_fundamentals.md`](../01_foundations/1.1_llm_fundamentals.md) - Why systems need controlled interfaces and traceability
- [`../01_foundations/1.2_prompt_engineering.md`](../01_foundations/1.2_prompt_engineering.md) - Prompting as a behavior contract (especially when tools are involved)
- [`2.2_tool_calling.md`](./2.2_tool_calling.md) - Tool calling fundamentals (selection vs execution, contracts, safety)

**Related:**
- [`2.4_guardrails.md`](./2.4_guardrails.md) - Enforcement patterns (allowlists, validation, policy checks)
- [`2.5_evals.md`](./2.5_evals.md) - Measuring quality/safety and gating changes
- [`2.7_agentic_ai.md`](./2.7_agentic_ai.md) - MCP as an integration surface for agentic systems
- [`2.1_rag.md`](./2.1_rag.md) - How MCP can provide governed access to retrieval sources and corpora
...
M**CP matters because it turns integrations into a reusable platform capability. Instead of every AI application embedding credentials, error handling, and access rules, MCP lets you expose approved tools and resources through a standardized server interface.** The platform team can centralize governance (what exists, who owns it, who can use it) while product teams move faster by reusing integration building blocks.
...
- [`2.2_tool_calling.md`](./2.2_tool_calling.md) - Tool contracts, safety boundaries, and truthful confirmations
- [`2.4_guardrails.md`](./2.4_guardrails.md) - Policy enforcement, validation, and injection defenses
- [`2.5_evals.md`](./2.5_evals.md) - Gating changes and measuring end-to-end outcomes
- [`2.7_agentic_ai.md`](./2.7_agentic_ai.md) - Using MCP as a safe integration layer for agentic workflows
