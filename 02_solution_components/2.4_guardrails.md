...
**Prerequisites:**
- [`../01_foundations/1.1_llm_fundamentals.md`](../01_foundations/1.1_llm_fundamentals.md) - Why models are not a security boundary (and why enforcement must be server-side)
- [`../01_foundations/1.2_prompt_engineering.md`](../01_foundations/1.2_prompt_engineering.md) - Prompts as behavior contracts, and how injection breaks them
- [`../01_foundations/1.3_hallucinations_basics.md`](../01_foundations/1.3_hallucinations_basics.md) - Why trust requires layered mitigation and measurement

**Related:**
- [`2.1_rag.md`](./2.1_rag.md) - Treat corpora as untrusted input and enforce ABAC at retrieval time
- [`2.2_tool_calling.md`](./2.2_tool_calling.md) - Tool safety contracts: allowlists, validation, idempotency, truthful confirmation
- [`2.5_evals.md`](./2.5_evals.md) - Prove guardrails work (and block releases on P0 failures)
- [`2.6_observability_llomps.md`](./2.6_observability_llomps.md) - Operate safety in production (monitoring, traces, incident loops)
...
- [`2.5_evals.md`](./2.5_evals.md) - Turn guardrails into evidence and release gates (P0 failures block shipping)
- [`2.2_tool_calling.md`](./2.2_tool_calling.md) - Implement the tool safety contract end-to-end (auth, validation, idempotency, truthful confirmation)
- [`2.1_rag.md`](./2.1_rag.md) - Handle injection from documents and enforce ABAC at retrieval time
- [`2.6_observability_llomps.md`](./2.6_observability_llomps.md) - Monitor safety and close the incident-to-regression loop in production
- [`../05_resources/5.1_books_and_papers.md`](../05_resources/5.1_books_and_papers.md) - Deepen security, privacy, and safety concepts with curated references
