...
**Prerequisites:**
- [`../01_foundations/1.1_llm_fundamentals.md`](../01_foundations/1.1_llm_fundamentals.md) - Why models predict plausibility, not truth (tokens, context limits, non-determinism)
- [`../01_foundations/1.2_prompt_engineering.md`](../01_foundations/1.2_prompt_engineering.md) - Prompting as behavior contracts (citations, abstention, output formats)
- [`../01_foundations/1.3_hallucinations_basics.md`](../01_foundations/1.3_hallucinations_basics.md) - Hallucination failure modes and layered mitigations

**Related:**
- [`2.5_evals.md`](./2.5_evals.md) - Measuring retrieval quality, groundedness, and release gating
- [`2.4_guardrails.md`](./2.4_guardrails.md) - Prompt injection defense, data protection, policy enforcement
- [`2.2_tool_calling.md`](./2.2_tool_calling.md) - When to use tools instead of retrieval (real-time state/actions)
- [`2.3_mcp.md`](./2.3_mcp.md) - Standardizing access to enterprise data/tools through a governed integration layer
- [`../03_use_case_archetypes/3.3_knowledge_management.md`](../03_use_case_archetypes/3.3_knowledge_management.md) - Knowledge lifecycle, corpus governance, and KM operating model
...
```
OFFLINE (CORPUS)                                ONLINE (QUERY)

  Documents -> Parse/Clean -> Chunk + Metadata -> Embed + Index
                                                   |
User Question -> Query Rewrite (optional) -> Retrieve (top-k) -> Rerank (optional)
                                                   |
                                    Build Context -> Generate + Cite -> Validate
                                                   |
...
- [`2.5_evals.md`](./2.5_evals.md) - How to measure retrieval vs groundedness and gate changes
- [`2.4_guardrails.md`](./2.4_guardrails.md) - Prompt injection defense, redaction, and policy enforcement
- [`2.2_tool_calling.md`](./2.2_tool_calling.md) - When to use tools for real-time state/actions instead of RAG
- [`../03_use_case_archetypes/3.3_knowledge_management.md`](../03_use_case_archetypes/3.3_knowledge_management.md) - Corpus lifecycle, ownership, and KM operating model