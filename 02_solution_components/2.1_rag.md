...
**Prerequisites:**
- [`../01_foundations/1.1_llm_fundamentals.md`](../01_foundations/1.1_llm_fundamentals.md) — Understanding LLM caps and limitations
- [`../01_foundations/1.2_prompt_engineering.md`](../01_foundations/1.2_prompt_engineering.md) — How to structure prompts for RAG
- [`../01_foundations/1.3_hallucinations_basics.md`](../01_foundations/1.3_hallucinations_basics.md) — Why RAG is essential for reducing hallucinations

**Related:**
- [`2.5_evals.md`](./2.5_evals.md) — Measuring RAG quality (retrieval precision/recall, context relevance)
- [`2.4_guardrails.md`](./2.4_guardrails.md) — Security controls for RAG (ABAC, sanitization)
- [`3.3_knowledge_management.md`](../03_use_case_archetypes/3.3_knowledge_management.md) — RAG in knowledge management use cases
