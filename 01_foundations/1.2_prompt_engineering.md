...
**Prerequisites:**
- [`1.1_llm_fundamentals.md`](./1.1_llm_fundamentals.md) — Understanding how LLMs work (tokens, context, prediction)

**Related:**
- [`1.3_hallucinations_basics.md`](./1.3_hallucinations_basics.md) — Mitigating false information generation
- [`../02_solution_components/2.4_guardrails.md`](../02_solution_components/2.4_guardrails.md) — Technical controls for safety
- [`../02_solution_components/2.5_evals.md`](../02_solution_components/2.5_evals.md) — Testing and validating prompt quality
- [`../02_solution_components/2.1_rag.md`](../02_solution_components/2.1_rag.md) — Expanding LLM knowledge with corporate data
