...
- [`1.3_hallucinations_basics.md`](./1.3_hallucinations_basics.md) — Understanding and mitigating hallucinations
- [`../02_solution_components/2.1_rag.md`](../02_solution_components/2.1_rag.md) — Expanding model knowledge with corporate data
