...
**Prerequisites:**
- [`1.1_llm_fundamentals.md`](./1.1_llm_fundamentals.md) - Why LLMs optimize plausibility (not truth) and why non-determinism is normal
- [`1.2_prompt_engineering.md`](./1.2_prompt_engineering.md) - How prompts define behavior contracts (abstention, citations, output formats)

**Related:**
- [`../02_solution_components/2.1_rag.md`](../02_solution_components/2.1_rag.md) - Grounding answers in enterprise sources (retrieval + citations)
- [`../02_solution_components/2.4_guardrails.md`](../02_solution_components/2.4_guardrails.md) - Enforcing safety (policy, validation, redaction)
- [`../02_solution_components/2.5_evals.md`](../02_solution_components/2.5_evals.md) - Measuring hallucination rates and gating releases
- [`../02_solution_components/2.2_tool_calling.md`](../02_solution_components/2.2_tool_calling.md) - Preventing "hallucinated actions" and enforcing truthful confirmations
...
- [`1.2_prompt_engineering.md`](./1.2_prompt_engineering.md) - Prompt patterns for abstention, clarification, and output contracts
- [`../02_solution_components/2.1_rag.md`](../02_solution_components/2.1_rag.md) - Grounding and citation patterns (and how to debug retrieval misses)
...
- [`../02_solution_components/2.5_evals.md`](../02_solution_components/2.5_evals.md) - How to measure hallucinations and gate releases with evidence
- [`../02_solution_components/2.2_tool_calling.md`](../02_solution_components/2.2_tool_calling.md) - Preventing hallucinated actions and confirming outcomes truthfully
